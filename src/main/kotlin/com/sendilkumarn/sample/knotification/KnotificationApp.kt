package com.sendilkumarn.sample.knotification

import com.sendilkumarn.sample.knotification.config.ApplicationProperties
...
class KnotificationApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes knotification.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KnotificationApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KnotificationApp::class.java)
