package com.sendilkumarn.sample.knotification.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.sendilkumarn.sample.knotification.repository..*)" +
            " || within(com.sendilkumarn.sample.knotification.service..*)" +
            " || within(com.sendilkumarn.sample.knotification.web.rest..*)"
    )
