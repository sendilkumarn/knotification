...
@Configuration
@EnableMongoRepositories("com.sendilkumarn.sample.knotification.repository")
...
class DatabaseConfiguration {
    ...
    fun mongobee(mongoClient: MongoClient, mongoTemplate: MongoTemplate, mongoProperties: MongoProperties): Mongobee {
        ...
        return Mongobee(mongoClient).apply {
            ...
            setChangeLogsScanPackage("com.sendilkumarn.sample.knotification.config.dbmigrations")
            isEnabled = true
        }
    }
}
